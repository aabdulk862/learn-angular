...
@Component({
  ...
  template: `
    <div class="demo-container">
      ...
      <p class="intro">Angular 18 introduces new built-in control flow syntax that replaces structural directives.</p>
      
      <!-- @if example -->
      <section class="demo-section">
        <h3>&#64;if Syntax</h3>
        <p class="description">The &#64;if block conditionally displays content. It replaces *ngIf.</p>
...
&lt;/ng-template&gt;</pre>
      ...
      <section class="demo-section">
        <h3>&#64;for Syntax</h3>
        <p class="description">The &#64;for block iterates over collections with required track expressions for performance.</p>
        ...
        <div class="code-comment">
          <strong>Legacy equivalent:</strong>
          <pre>&lt;div *ngFor="let item of items; trackBy: trackById"&gt;
  item.name
&lt;/div&gt;
...
&lt;/ng-container&gt;</pre>
      ...
      <section class="demo-section">
        <h3>&#64;switch Syntax</h3>
        <p class="description">The &#64;switch block displays content based on matching cases. It replaces *ngSwitch.</p>
...
&lt;/div&gt;</pre>
      ...
      <section class="demo-section summary">
        ...
        <ul>
          <li>✓ Built-in syntax - no imports needed (except FormsModule for [(ngModel)])</li>
          <li>✓ Better type checking and IDE support</li>
          <li>✓ More readable and intuitive syntax</li>
          <li>✓ Required track expressions prevent common performance issues</li>
          <li>✓ &#64;empty block for &#64;for provides cleaner empty state handling</li>
        </ul>
      </section>
    </div>
  `,
...
export class ControlFlowDemoComponent {
  ...
  // @for demo state
  items = [
    { id: 1, name: 'Angular Components', description: 'Building blocks of Angular applications' },
    { id: 2, name: 'Services & DI', description: 'Dependency injection and shared logic' },
  ...
  cycleStatus(): void {
    const statuses: Array<'success' | 'warning' | 'error' | 'unknown'> = ['success', 'warning', 'error', 'unknown'];
