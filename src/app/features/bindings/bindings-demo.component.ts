...
@Component({
  ...
  template: `
    <div>
      ...
      <p>This demo showcases the four types of data binding in Angular: Interpolation, Property Binding, Event Binding, and Two-way Binding.</p>
      
      <!-- Interpolation Section -->
      <section class="demo-section">
        <h3>1. Interpolation {{ '{{' }} {{ '}}' }}</h3>
        <p class="explanation">Interpolation displays component data in the template using double curly braces.</p>
      ...
      <section class="demo-section">
        ...
        <p class="explanation">Property binding sets element properties and attributes dynamically using square brackets.</p>
        ...
        <div class="example">
          ...
          <button [disabled]="isButtonDisabled">{{ isButtonDisabled ? 'Disabled Button' : 'Enabled Button' }}</button>
          <button (click)="toggleButtonState()">Toggle Button State</button>
          
          <p><strong>Dynamic ID attribute:</strong></p>
          <div [id]="dynamicId" [class.highlight]="isHighlighted" style="padding: 10px; border: 2px solid #4CAF50;">
      ...
      <section class="demo-section">
        ...
        <p class="explanation">Event binding listens to user events like clicks, inputs, and key presses using parentheses.</p>
        ...
        <div class="example">
          ...
          <div 
            ...
            style="padding: 20px; background-color: {{ mouseOverColor }}; border: 2px solid #333; border-radius: 4px;">
            Hover over me!
          </div>
        </div>
      </section>
      ...
      <section class="demo-section">
        ...
        <p class="explanation">Two-way binding combines property and event binding to sync data between component and template using [(ngModel)].</p>
      ...
      <section class="demo-section">
        ...
        <p class="explanation">A practical example using all four binding types together.</p>
