...
@Component({
  ...
  template: `
    <div class="signals-demo">
      ...
      <p class="intro">
        Signals are Angular 18's new reactive primitive for managing state.
        They provide fine-grained reactivity and automatic change detection.
      </p>
      ...
      <section class="demo-section">
        ...
        <p class="description">
          The signal() function creates reactive state. When the signal value changes,
          the UI automatically updates without manual change detection.
        </p>
...
decrement() &#123; this.count.update(n => n - 1); &#125;</pre>
      ...
      <section class="demo-section">
        ...
        <p class="description">
          The computed() function creates derived state that automatically recalculates
          when its dependencies change. Computed signals are read-only.
        </p>
        ...
        <div class="computed-display">
          ...
          <div class="computed-item">
            ...
            <span class="value" [class.true]="isEven()" [class.false]="!isEven()">
              {{ isEven() ? '✓ Yes' : '✗ No' }}
            </span>
          </div>
          <div class="computed-item">
        ...
        <div class="code-example">
          <strong>Code:</strong>
          <pre>doubleCount = computed(() => this.count() * 2);
...
&#125;);</pre>
      ...
      <section class="demo-section">
        ...
        <p class="description">
          The effect() function runs side effects when signals change.
          Open your browser console (F12) to see effect logs when you change the counter.
        </p>
        ...
        <div class="effect-info">
          <div class="info-box">
            ...
            <p>
              An effect is watching the count signal and logging changes to the console.
              Try incrementing or decrementing to see the logs!
            </p>
          </div>
        </div>
...
&#125;</pre>
      ...
      <section class="demo-section">
        ...
        <p class="description">
          Signals can hold complex objects. Use set() to replace the entire value,
          or update() to modify it based on the current value.
        </p>
        ...
        <div class="button-group">
          <button (click)="updateUserAge()" class="btn">Increment Age (update)</button>
          <button (click)="changeUser()" class="btn">Change User (set)</button>
        </div>
        
        <div class="code-example">
          <strong>Code:</strong>
          <pre>user = signal(&#123; name: 'Alice', age: 25, email: 'alice&#64;example.com' &#125;);
...
&#125;</pre>
      ...
      <section class="demo-section comparison">
        ...
        <p class="note">
          ...
          Use signals for local component state and computed values.
          Use observables for async operations like HTTP requests and event streams.
        </p>
      </section>
      ...
      <section class="demo-section summary">
        ...
        <ul>
          <li>✓ Automatic change detection - no need for manual markForCheck()</li>
