...
@Component({
  ...
  template: `
    <div class="http-demo">
      ...
      <p class="description">
        This demo shows how to make HTTP requests and handle responses using Angular's HttpClient.
        We're using the JSONPlaceholder API for demo data.
      </p>

      <!-- GET Request Section -->
      <section class="demo-section">
        <h3>GET Request - Fetch Users</h3>
        <p>Click the button to load users from the API. The async pipe automatically subscribes and unsubscribes.</p>
      ...
      <section class="demo-section">
        ...
        <p>Click to create a new user. The API will return the created user with an ID.</p>
      ...
      <section class="demo-section">
        ...
        <p>Using the map operator to transform user data (extracting just names).</p>
        <button (click)="loadUserNames()" class="btn">Load User Names Only</button>
      ...
      <section class="demo-section">
        ...
        <p>Demonstrating error handling with catchError operator. This triggers an invalid request.</p>
        <button (click)="loadWithError()" class="btn btn-danger">Trigger Error</button>
