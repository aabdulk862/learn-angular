...
@Component({
  ...
  template: `
    <div class="services-demo">
      ...
      <p class="intro">This demo shows two ways to inject services in Angular 18</p>

      <!-- DataService Demo - Constructor Injection -->
      <section class="demo-section">
        <h3>DataService - Constructor Injection</h3>
        <p class="explanation">
          DataService is injected via constructor (traditional pattern).
          It uses signals for reactive state management.
        </p>
      ...
      <section class="demo-section">
        ...
        <p class="explanation">
          UserService is injected using the inject() function (Angular 18 pattern).
          It demonstrates HTTP requests and observable handling.
        </p>
      ...
      <section class="demo-section">
        ...
        <p class="explanation">
          The DataService maintains shared state across the application.
          Any component can access and modify this data, demonstrating
          how services enable communication between components.
        </p>
        <div class="info-box">
          <p>💡 Try navigating to other components and back - the data persists!</p>
          <p>💡 The DataService uses signals, so updates are automatically reactive.</p>
        </div>
      </section>
    </div>
  `,
