...
- [ ] 2. Update Home Component layout
...
- [ ] 3. Update Components Demo layout
...
- [ ] 4. Update Directives Demo layout
...
- [ ] 5. Update Control Flow Demo layout
  - [-] 5.1 Apply .demo-container class to control-flow-demo.component.ts template
...
- [ ] 6. Update Forms Components layout
  - [~] 6.1 Apply .demo-container class to reactive-form.component.ts template
  ...
  - [~] 6.2 Apply .demo-container class to template-form.component.ts template
    - Update template to use .demo-container class
    - Remove duplicate layout styles from component
    - _Requirements: 3.6, 4.4, 5.2_

- [ ] 7. Update HTTP Demo layout
  - [~] 7.1 Apply .demo-container class to http-demo.component.ts template
...
- [ ] 8. Update Services Demo layout
  - [~] 8.1 Apply .demo-container class to services-demo.component.ts template
    - Add .demo-container class to root element
    - Remove any duplicate layout styles
    - _Requirements: 3.8, 4.4, 5.2_

- [ ] 9. Update Signals Demo layout
  - [~] 9.1 Apply .demo-container class to signals-demo.component.ts template
    - Add .demo-container class to root element
    - Remove any duplicate layout styles
    - _Requirements: 3.9, 4.4, 5.2_

- [ ] 10. Update Module Demo layout
  - [~] 10.1 Apply .demo-container class to module-demo.component.ts template
    - Add .demo-container class to root element
    - Remove any duplicate layout styles
    - _Requirements: 3.10, 4.4, 5.2_

- [~] 11. Checkpoint - Verify layout consistency
...
- [ ] 12. Update Bindings Demo layout (if exists)
  - [~] 12.1 Check if bindings component exists in src/app/features/bindings
